...
private:
    rclcpp::Subscription<navigation_interfaces::msg::NavState>::SharedPtr sub_nav;
...
public:
    Control() : Node("car_control") {
        sub_nav = this->create_subscription<navigation_interfaces::msg::NavState>("nav_topic", 10, std::bind(&Control::callback_nav, this, _1));
    ...
    void callback_nav(const navigation_interfaces::msg::NavState::SharedPtr msg) {
        pp.state_update(msg);
